...
#### 1.2 female #####
female.file.list=list.files("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/paired_data/female")
female_file_mydiff_final_list <- NA
setwd("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/paired_data/female")
...
colnames(female_file_mydiff_final_list)[4:23] <- gsub("X","",colnames(female_file_mydiff_final_list[4:23]))
...
# 367305
saveRDS(female_file_mydiff_final_list_,"~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/female_intersect_mydiff_final_list.rds")
female_file_mydiff_final_list_ <- readRDS("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/female_intersect_mydiff_final_list.rds")
nrow(female_file_mydiff_final_list_)
## convert back to GRanges
female_mydiff_GR <- as(female_file_mydiff_final_list_,"GRanges")
female_mydiff_df <- female_file_mydiff_final_list_
####  1.3 male  ######
male.file.list=list.files("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/paired_data/male")
male_file_mydiff_final_list <- NA
setwd("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/paired_data/male")
...
#male_file_mydiff_final_list <- na.omit(male_file_mydiff_final_list)
colnames(male_file_mydiff_final_list)[4:39] <- gsub("X","",colnames(male_file_mydiff_final_list[4:39]))
...
male_file_mydiff_final_list_ <- male_file_mydiff_final_list_[abs(rowMeans(male_file_mydiff_final_list_[,4:39],na.rm=T)) >= 0,]
nrow(male_file_mydiff_final_list_)
# 376246
saveRDS(male_file_mydiff_final_list_,"~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/male_intersect_mydiff_final_list.rds")
male_file_mydiff_final_list_ <- readRDS("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/male_intersect_mydiff_final_list.rds")
nrow(male_file_mydiff_final_list_)
## convert back to GRanges
male_mydiff_GR <- as(male_file_mydiff_final_list_,"GRanges")
male_mydiff_df <- male_file_mydiff_final_list_
####  1.4 fvsm #####
fvsm_myDiff <- readRDS("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/BL60_FvsM_DMR_mydiff.rds")
...
colnames(mcols(only_f_gr))[21] <- "meth.diff.gender"

only_f_gr <- readRDS("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/only_f_gr.rds")
...
colnames(mcols(only_m_gr))[37] <- "meth.diff.gender"
saveRDS(only_m_gr,"~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_Bl60/10. Methylation/only_m_gr.rds")
...
only_f_promoter$meth.diff.tn.mean <- rowMeans(only_f_promoter[,c(6:25)],na.rm=T)
only_m_promoter$meth.diff.tn.mean <- rowMeans(only_m_promoter[,c(6:41)],na.rm=T)

summary(abs(only_f_promoter$meth.diff.tn.mean))
summary(abs(only_m_promoter$meth.diff.tn.mean))

### plot prep
only_f_promoter$type <- "Female only"
only_m_promoter$type <- "Male only"

### get top 5 meth.diff.gender gene in each gender
labeled_genes_f <- only_f_promoter[order(abs(only_f_promoter$meth.diff.gender),decreasing = T),]
...
labeled_genes <- df_meth_diff_gene_promoter_df_[abs(df_meth_diff_gene_promoter_df_$avg_gender) > 10,]
...
pdf("~/onedrive/Work/phD/phd_project/TME_gender/results/BaiduII_BL60/10. Methylation/methylation_plot_methdiff_tvsn_fvsm_promoter.pdf",width = 10,height = 5)
p17
dev.off()
